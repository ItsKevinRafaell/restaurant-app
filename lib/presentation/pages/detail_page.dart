...
class _DetailPageState extends State<DetailPage> {
      ...
      body: Consumer2<RestaurantDetailProvider, FavoriteProvider>(
        builder: (context, detailProvider, favoriteProvider, child) {
          switch (detailProvider.state) {
            case RestaurantDetailLoadingState _:
              return const Center(
                child: CircularProgressIndicator(),
              );

            case RestaurantDetailErrorState _:
              return Center(
                child: Column(
            ...
            case RestaurantDetailLoadedState _:
              if (detailProvider.restaurant == null) {
                return const SizedBox();
              }
              return _buildLoadedContent(
                  context, detailProvider.restaurant!, favoriteProvider);
  ...
  Widget _buildLoadedContent(BuildContext context, RestaurantDetail restaurant,
